...
class VuePluginAdminExtra(ModelAdmin):
    ...
    fieldsets = (
        (_('Repository Info'), {'fields': ('name', 'repo_url', 'tags', 'npm_package_name', 'last_release_tag_name'
                                           , 'repo_license_name', 'repo_num_open_issues')}),
        (_('Manual Review Fields'),
         {'fields': ('has_demo', 'has_meaningful_tests', 'has_example_code', 'has_api_documented', 'has_ci',)}),
        (_('Automatic Review Fields'),
         {'fields': (
         'last_release_date', 'num_commits_recently', 'num_contributors', 'num_downloads_recently', 'num_stars',)}),
        (_('Score'),
         {'fields': ('score',)}),
    )

    readonly_fields = (
    'last_release_date', 'npm_package_name', 'last_release_tag_name', 'num_commits_recently', 'num_contributors',
    'num_downloads_recently', 'num_stars', 'score', 'repo_license_name', 'repo_num_open_issues')
